...
CharCode charCodes[256] = {
  ...
  CHAR_SPACE, CHAR_EXCLAIMATION, CHAR_UNKNOWN, CHAR_DOLLASIGN, CHAR_UNKNOWN, CHAR_UNKNOWN, CHAR_UNKNOWN, CHAR_SINGLEQUOTE,
  ...
  CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER,
  CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LSBRACKET, CHAR_UNKNOWN, CHAR_RSBRACKET, CHAR_UNKNOWN, CHAR_UNDERSCORE,
